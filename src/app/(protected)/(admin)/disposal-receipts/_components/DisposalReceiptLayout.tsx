...
import { DisposalReceiptSearch } from './DisposalReceiptSearch'
import { DisposalReceiptTable } from './DisposalReceiptTable'
import { DisposalReceiptToolbar } from './DisposalReceiptToolbar'

export const DisposalReceiptLayout = () => {
